...
class ConnectorTemplate:
    ...
    def _collect_intelligence(self) -> list:
        ...
        stix_object = {
            "type": "indicator",
            "spec_version": "2.1",
            "id": f"indicator--{stix_id}",
            "created": "2021-06-01T00:00:00.000Z",
            "modified": "2021-06-01T00:00:00.000Z",
            "name": "Malicious site hosting malware",
            "description": "This indicator represents a malicious site that is known to host malware.",
            "indicator_types": ["malicious-activity"],
            "pattern": "[url:value = 'http://www.example.com']",
            "pattern_type": "stix",
            "pattern_version": "2.1",
            "valid_from": "2021-06-01T00:00:00.000Z",
            ...
            "external_references": [
                {
                    "source_name": "urlhaus",
                    "url": "https://urlhaus.abuse.ch/url/12345/"
                }
            ]
        }
